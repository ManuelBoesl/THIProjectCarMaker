...
** Unity Connection:
**
** User_Init_First() -> Initializating UDP sender
** User_TestRun_Start_atBegin() -> start UDP Connection
** User_Calc() -> Get Data and send UDP Packet
**
** Keyboard Control:
**
** User_Init_First() -> Initializing Keyboard Controller
** User_IN() -> Receive UDP Data and translate the EgoVhcl
**
*/
...
// UDP Sender for CarMaker - Unity connection
UDP_Sender* sender;
UDP_Client* client;

// Keyboard Controller
// Keyboard_Controller* keycontrol;
...
User_Init_First(void)
{
    ...
    // Initialize UDP Keyboard Controller
    // keycontrol = Keyboard_Controller_new();
    // Initialize UDP Sender for Unity Connection
    sender = UDP_Sender_new();
...
User_In(const unsigned CycleNo)
{
    ...
    // Set EgoVhcl Controls accordign to received UDP Data
    //Keyboard_Controller_TranslateEgoVhcl(keycontrol);
}
