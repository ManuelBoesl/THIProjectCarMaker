...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 9.0 2020-05-15",
    "libcarmaker.a	CarMaker win64 9.0 2020-05-15",
    "libipgdriver.a	IPGDriver win64 9.0 2020-04-21",
    "libipgroad.a	IPGRoad win64 9.0 2020-05-15",
...
static const char *CompileFlags[] = {
    "-O3 -m64 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=90000",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 9.0 - Car_Generic",          /* App_Version         */
    "1244",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2020-05-15 16:23:44",  /* App_CompileTime */
